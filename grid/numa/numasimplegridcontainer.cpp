...
asagi::Grid::Error grid::SimpleGridContainer::setParam(const char* name, const char* value,
        unsigned int level) {
    Error result;
...
asagi::Grid::Error grid::SimpleGridContainer::open(const char* filename, unsigned int level) {
    Error result;
...
#ifndef ASAGI_NOMPI
asagi::Grid::Error grid::SimpleGridContainer::setComm(MPI_Comm comm) {
